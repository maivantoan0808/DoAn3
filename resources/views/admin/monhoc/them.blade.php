    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-7" style="padding-bottom:120px">
                ...
                @endif
                <form action="admin/monhoc/them" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group" style="display: none;" id="money">
                        <label>Money</label>
                        <input required="" type="number" class="form-control" name="money" placeholder="Nhập phí môn học" value="0" />
                    </div>
