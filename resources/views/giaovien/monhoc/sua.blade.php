    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-7" style="padding-bottom:120px">
                ...
                @endif
                <form action="giaovien/monhoc/sua/{{$monhoc->id}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group"  style="display: @if($monhoc->khoahoc->loai==0){{"none"}} @else {{"block"}} @endif;" id="money">
                    <label>Money</label>
                    <input required="" id="tien" type="number" value="{{$monhoc->money}}" class="form-control" name="money" placeholder="Nhập phí môn học" />
                </div>
